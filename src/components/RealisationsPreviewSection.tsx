...
const identityLogos = [
  ...
  { name: "FRULUX", category: "Média", sector: "Blog Connecté", style: "Éditorial rouge premium", description: "Direction de marque conçue pour FRULUX, blog connecté premium mêlant culture, lifestyle et tech avec une signature rouge cinématique.", imageUrl: fruluxLogo.url, accent: "from-red-500/25 via-transparent to-zinc-900/20" },
              ...
              <>
                ...
                <div className="absolute inset-0 px-5 py-5 flex flex-col justify-between">
                  <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.28em] text-white/80">
                    <span className="drop-shadow-md">Landing Page Lab</span>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-wrap gap-1.5 text-[10px] uppercase tracking-[0.24em] text-white/80">
                      <span className="rounded-full border border-white/15 bg-black/40 backdrop-blur-sm px-2 py-0.5">Auto</span>
                      <span className="rounded-full border border-white/15 bg-black/40 backdrop-blur-sm px-2 py-0.5">SaaS</span>
          ...
          >
            ...
            <div className="identity-portfolio-header relative border-b border-white/8 px-4 pb-3 pt-4 md:px-8 md:pb-6 md:pt-7">
              ...
              <div className="relative max-w-3xl pr-12">
                  ...
                  <h3 className="mt-2 md:mt-4 text-xl sm:text-2xl md:text-4xl lg:text-5xl font-heading font-bold leading-tight text-surface-dark-foreground">
              ...
              <div className="relative mt-3 md:mt-5 -mx-4 lg:mx-0 px-4 lg:px-0 flex gap-2 md:gap-2.5 overflow-x-auto lg:flex-wrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {identityFilters.map((filter) => (
                  <button
                    ...
                    className={`shrink-0 rounded-full border px-3 md:px-3.5 py-1.5 md:py-2 text-[10px] md:text-[11px] uppercase tracking-[0.2em] md:tracking-[0.24em] transition-all duration-300 ${activeFilter === filter ? "border-primary/45 bg-primary/12 text-primary shadow-[0_0_24px_rgba(239,68,68,0.12)]" : "border-white/10 bg-white/5 text-surface-dark-foreground/50 hover:border-white/20 hover:text-surface-dark-foreground/80"}`}
                  >
                    {filter}
                  </button>
                ))}
